...
<template>
    ...
    <div class="w-full grow italic flex flex-col border-color-light-blue
        ...
        <div class="w-full p-5 pb-0 md:pb-5 sm:w-1/2 md:w-full">
            <div class="font-bold text-[#455393]">We will finalize the last .NET 9 release in January 2026, after which we will 
            shift our focus to the .NET 10 release, which will include features such as Tailwind 4.1 support.</div>
        </div>
