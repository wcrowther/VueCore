...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/admin/examples': RouteRecordInfo<'/admin/examples', '/admin/examples', Record<never, never>, Record<never, never>>,
    '/admin/examples/': RouteRecordInfo<'/admin/examples/', '/admin/examples', Record<never, never>, Record<never, never>>,
    '/admin/examples/[search]': RouteRecordInfo<'/admin/examples/[search]', '/admin/examples/:search', { search: ParamValue<true> }, { search: ParamValue<false> }>,
