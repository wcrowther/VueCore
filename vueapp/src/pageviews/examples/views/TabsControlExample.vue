...
<template>
	...
	<div class="p-7">
		...
		<div class="font-bold mb-7">
			1. Primitive list (strings/numbers)
		</div>

		<TabsControl :tabList="primitiveTabs" altDesign
			class="mb-7" contentBorder :minHeight="100" >
		...
		<div class="font-bold mb-7">
			2. Lookup object (uses value as default)
		</div>

		<TabsControl :tabList="lookupTabs" 
			class="mb-7" contentBorder :minHeight="100" >
		...
		<div class="font-bold mb-7">
			4. Object list (dynamic templates from description)
		</div>

		<TabsControl :tabList="radiationTabs" tabFieldName="title" 
			class="mb-7" contentBorder :minHeight="180" >	
