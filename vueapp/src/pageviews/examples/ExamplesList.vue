<script setup>
    ...
    const hideSearch            = useLocalStorage('examplesHideSearch', false)
...
<template>
    <div id="examplesList">
        ...
        <!-- MobilePagerPrevNext & ExamplesAdvSearch absolutely positioned -->
        ...
        <TopDrawerControl v-model:drawerHidden="hideSearch">
